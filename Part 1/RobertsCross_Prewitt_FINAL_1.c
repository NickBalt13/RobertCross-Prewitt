...
int i,j; //ZI Data --> ZI is RW that is not initialized

//User's Variables for Chooseing Image & Operator
int selection = 2; //RO Data
int option = 1;

//Our Declared Global Variables -> heap
int Gx_RcMask[2][2];
int Gy_RcMask[2][2];
int Gx_PrMask[3][3];
int Gy_PrMask[3][3];
...
int temp[N+2][M+2];
int limit=1;
int newPixel, row, col, kernelRow, kernelCol, ttt;
  ...
  for(row=1; row<=N-1; row++)    
    {
      for(col=1; col<=M-4; col+=3)
      {
       newPixel= 0;  //turning the pixel black
        ...
        newPixel= 0;  //turning the pixel black
        newPixel= temp[row][col+1]   * Gx_RcMask[0][0] + temp[row][col+2]   * Gx_RcMask[0][1]+
                  temp[row+1][col+1] * Gx_RcMask[1][0] + temp[row+1][col+2] * Gx_RcMask[1][1];

        IGx[row-1][col]= (int)(floor(newPixel));

        newPixel= 0;  //turning the pixel black
        newPixel= temp[row][col+2]   * Gx_RcMask[0][0] + temp[row][col+3]   * Gx_RcMask[0][1]+
                  temp[row+1][col+2] * Gx_RcMask[1][0] + temp[row+1][col+3] * Gx_RcMask[1][1];
        ...
        newPixel= 0;  //turning the pixel black
        newPixel= temp[row][col+1]   * Gy_RcMask[0][0] + temp[row][col+2]   * Gy_RcMask[0][1]+
                  temp[row+1][col+1] * Gy_RcMask[1][0] + temp[row+1][col+2] * Gy_RcMask[1][1];

        IGy[row-1][col]= (int)(floor(newPixel));

        newPixel= 0;  //turning the pixel black
        newPixel= temp[row][col+2]   * Gy_RcMask[0][0] + temp[row][col+3]   * Gy_RcMask[0][1]+
                  temp[row+1][col+2] * Gy_RcMask[1][0] + temp[row+1][col+3] * Gy_RcMask[1][1];
...
void Prewitt()
{
  ...
  for(row=0; row<=N-1; row++)    
  {
    for(col=0; col<=M-4; col+=3)
    {
      ...
      newPixel= 0;  //turning the pixel black
      newPixel= temp[row][col+1]   * Gx_PrMask[0][0] + temp[row][col+2]   * Gx_PrMask[0][1] + temp[row][col+3]     * Gx_PrMask[0][2]+
                temp[row+1][col+1] * Gx_PrMask[1][0] + temp[row+1][col+2] * Gx_PrMask[1][1] + temp[row+1][col+3]   * Gx_PrMask[1][2]+
                temp[row+2][col+1] * Gx_PrMask[2][0] + temp[row+2][col+2] * Gx_PrMask[2][1] + temp[row+2][col+3]   * Gx_PrMask[2][2];

      IGx[row][col+1]= (int)(floor(newPixel));

      newPixel= 0;  //turning the pixel black
      newPixel= temp[row][col+2]   * Gx_PrMask[0][0] + temp[row][col+3]   * Gx_PrMask[0][1] + temp[row][col+4]     * Gx_PrMask[0][2]+
                temp[row+1][col+2] * Gx_PrMask[1][0] + temp[row+1][col+3] * Gx_PrMask[1][1] + temp[row+1][col+4]   * Gx_PrMask[1][2]+
                temp[row+2][col+2] * Gx_PrMask[2][0] + temp[row+2][col+3] * Gx_PrMask[2][1] + temp[row+2][col+4]   * Gx_PrMask[2][2];
      ...
      newPixel= 0;  //turning the pixel black
      newPixel= temp[row][col+1]   * Gy_PrMask[0][0] + temp[row][col+2]   * Gy_PrMask[0][1] + temp[row][col+3]     * Gy_PrMask[0][2]+
                temp[row+1][col+1] * Gy_PrMask[1][0] + temp[row+1][col+2] * Gy_PrMask[1][1] + temp[row+1][col+3]   * Gy_PrMask[1][2]+
                temp[row+2][col+1] * Gy_PrMask[2][0] + temp[row+2][col+2] * Gy_PrMask[2][1] + temp[row+2][col+3]   * Gy_PrMask[2][2];

      IGy[row][col+1]= (int)(floor(newPixel));

      newPixel= 0;  //turning the pixel black
      newPixel= temp[row][col+2]   * Gy_PrMask[0][0] + temp[row][col+3]   * Gy_PrMask[0][1] + temp[row][col+4]     * Gy_PrMask[0][2]+
                temp[row+1][col+2] * Gy_PrMask[1][0] + temp[row+1][col+3] * Gy_PrMask[1][1] + temp[row+1][col+4]   * Gy_PrMask[1][2]+
                temp[row+2][col+2] * Gy_PrMask[2][0] + temp[row+2][col+3] * Gy_PrMask[2][1] + temp[row+2][col+4]   * Gy_PrMask[2][2];
